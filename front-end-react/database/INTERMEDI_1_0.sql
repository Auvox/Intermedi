...
CREATE TABLE tbRedistribuicao (
	...
	fkIdFarmaciaOrigem INT NOT NULL FOREIGN KEY (fkIdFarmaciaOrigem) REFERENCES tbFarmacia(idFarmacia),
	fkIdFarmaciaDestino INT NOT NULL FOREIGN KEY (fkIdFarmaciaDestino) REFERENCES tbFarmacia(idFarmacia),
	fkIdGerente INT FOREIGN KEY (fkIdGerente) REFERENCES tbGerente(idGerente)
);
